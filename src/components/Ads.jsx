...
export const Ads = () => {
    ...
    function submitForm(e) {
        ...
        axios
            .post(`${API_PUBLIC_URL}api/ads`, formData)
            .then((res) => {
                            ...
                            <form onSubmit={submitForm} encType="multipart/form-data">
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-9">
                                        <input
                                            type="text"
                                            className="form-control"
                                            onChange={(e) => setAdsPage(e.target.value)}
                                            value={adsPage}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-9">
                                        <select
                                            className="form-control"
                                            onChange={(e) => setAdsGender(e.target.value)}
                                            value={adsGender}
                                        >
                                            <option>Please Select One</option>
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-9">
                                        <input
                                            type="number"
                                            className="form-control"
                                            onChange={(e) => setAdsMinAge(e.target.value)}
                                            value={adsMinAge}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-9">
                                        <input
                                            type="number"
                                            className="form-control"
                                            onChange={(e) => setAdsMaxAge(e.target.value)}
                                            value={adsMaxAge}
                                        />
                                    </div>
                                </div>
