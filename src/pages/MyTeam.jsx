      ...
      try {
        ...
        if (selectedTournament) {
          let getCurrentTournamentRangTeam = await axios.get(
            `${API_PUBLIC_URL}api/ws-my-team/${user.id}/test/${selectedTournament.id}`
          );
          let getAllCurrentTournamentRank = await axios.get(
                  ...
                  <div className="tournament-player-rank">
                    <ul>
                      <li className="rank-heading ku-card-header text-center">
                        <div className="rank-title rank-c">
                          Your Selected Team
                        </div>
                      </li>
                    </ul>
                    <div className="build-player-list-single-item px-4">
                      {userCurrentTeam.length ? (
                        ...
                        <div className="rank-heading p-2 text-center">
                          Team Not Found
                        </div>
                      )}
                    </div>
                ...
                {userCurrentTeam.length ? (
                  <div className="team-view-bottom-area mt-0 py-4">
                    <div className="d-inline-flex justify-content-center flex-column text-center">
                      <p>My Points</p>
                      <button
                        className="btn btn btn-lg  text-white"
                        style={{
                          minWidth: "200px",
                          borderRadius: "0",
                          background: "#565656",
                    ...
                    <div className="d-inline-flex justify-content-center flex-column text-center">
                      <p>My Rank</p>
                      <button
                        className="btn btn btn-success btn-lg text-white"
                        style={{
                          minWidth: "200px",
                          borderRadius: "0",
                          background: "#5ABE2B",
